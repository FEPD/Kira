Ext.define('Kira.store.KiraTimerTriggerBusinessRunningInstanceListInfoQuery', {
	extend : 'Ext.data.Store',
	model : 'Kira.model.KiraTimerTriggerBusinessRunningInstanceListInfoQuery',
	pageSize : 10,//per page show data count(pageSize)
	proxy : {
        type : 'ajax',
        url : 'triggerMetadata/getKiraTimerTriggerBusinessRunningInstanceListOnPage.action',
        actionMethods : {
        	read : 'POST'
        },
