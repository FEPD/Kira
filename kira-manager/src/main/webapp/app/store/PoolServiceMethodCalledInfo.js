Ext.define('Kira.store.PoolServiceMethodCalledInfo', {
	extend : 'Ext.data.Store',
	model : 'Kira.model.TaskServiceMethodCalledInfo',//use taskservicemethodcalledinfo model
	pageSize : 10,//per page show data count(pageSize)
	proxy : {
        type : 'ajax',
        url : 'triggerMetadata/getLatestTriggerMetadatasWhichSetTriggersOfPoolAsTargetOnPage.action',
        actionMethods : {
        	read : 'POST'
        },
