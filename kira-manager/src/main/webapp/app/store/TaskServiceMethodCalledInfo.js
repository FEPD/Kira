Ext.define('Kira.store.TaskServiceMethodCalledInfo', {
	extend : 'Ext.data.Store',
	model : 'Kira.model.TaskServiceMethodCalledInfo',
	pageSize : 10,//per page show data count(pageSize)
	proxy : {
        type : 'ajax',
        url : 'triggerMetadata/getLatestTriggerMetadatasWhichSetTriggerAsTargetOnPage.action',
        actionMethods : {
        	read : 'POST'
        },
