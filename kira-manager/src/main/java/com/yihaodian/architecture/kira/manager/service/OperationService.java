...
public interface OperationService {
  ...
  Operation select(Integer id);

  List<Operation> list(OperationCriteria operationCriteria);

  List<Operation> listOnPage(OperationCriteria operationCriteria);

  List<Operation> getAllOperations();

  List<Operation> getAllNotReadonlyOperations();
