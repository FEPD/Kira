...
public interface QrtzSimpleTriggersDao {
  ...
  void insert(QrtzSimpleTriggers qrtzSimpleTriggers) throws DataAccessException;

  int update(QrtzSimpleTriggers qrtzSimpleTriggers) throws DataAccessException;

  int delete(String triggerGroup, String triggerName) throws DataAccessException;

  QrtzSimpleTriggers select(String triggerGroup, String triggerName) throws DataAccessException;
  ...
  int count(QrtzSimpleTriggersCriteria qrtzSimpleTriggersCriteria) throws DataAccessException;
