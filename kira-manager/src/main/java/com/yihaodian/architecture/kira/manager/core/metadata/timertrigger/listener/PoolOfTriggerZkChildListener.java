...
public class PoolOfTriggerZkChildListener implements IZkChildListener {

  private static Logger logger = LoggerFactory.getLogger(PoolOfTriggerZkChildListener.class);

  private IKiraTimerTriggerMetadataManager kiraTimerTriggerMetadataManager;

  public PoolOfTriggerZkChildListener(
  ...
  public void handleChildChange(String parentPath, List<String> currentChilds)
      throws Exception {
    logger.info("The child Change event of trigger's pool detected. parentPath={}", parentPath);
    this.kiraTimerTriggerMetadataManager
        .handleChildChangeForPoolOfTrigger(parentPath, currentChilds);
  }
