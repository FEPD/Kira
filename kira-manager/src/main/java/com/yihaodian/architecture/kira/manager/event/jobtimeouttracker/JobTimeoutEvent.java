...
public class JobTimeoutEvent extends JobTimeoutTrackerEvent {

  public JobTimeoutEvent(JobTimeoutTracker jobTimeoutTracker,
      JobTimeoutTrackerEventType eventType) {
    super(jobTimeoutTracker, eventType);
  }

  public JobTimeoutEvent(JobTimeoutTracker jobTimeoutTracker,
      JobTimeoutTrackerEventType eventType, Date eventTime) {
