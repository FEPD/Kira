 ...
 */
package com.yihaodian.architecture.kira.manager.core.metadata.kiraclient.message;
...
public class KiraClientRegisterDataMessageHandler implements IMessageHandler {
  ...
  private static Logger logger = LoggerFactory
      .getLogger(KiraClientRegisterDataMessageHandler.class);

  private KiraClientMetadataService kiraClientMetadataService;

  public KiraClientRegisterDataMessageHandler(KiraClientMetadataService kiraClientMetadataService) {
