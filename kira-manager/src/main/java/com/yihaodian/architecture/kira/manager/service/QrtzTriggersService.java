...
public interface QrtzTriggersService {
  ...
  void insert(QrtzTriggers qrtzTriggers);

  int update(QrtzTriggers qrtzTriggers);

  int delete(String triggerGroup, String triggerName);

  QrtzTriggers select(String triggerGroup, String triggerName);

  List<QrtzTriggers> list(QrtzTriggersCriteria qrtzTriggersCriteria);

  List<QrtzTriggers> listOnPage(QrtzTriggersCriteria qrtzTriggersCriteria);

  int count(QrtzTriggersCriteria qrtzTriggersCriteria);
