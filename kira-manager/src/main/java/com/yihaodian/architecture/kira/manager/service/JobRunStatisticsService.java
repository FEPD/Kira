...
public interface JobRunStatisticsService {

  void insert(JobRunStatistics jobRunStatistics);

  int update(JobRunStatistics jobRunStatistics);

  int delete(Long id);

  JobRunStatistics select(Long id);
  ...
  JobRunStatistics getJobRunStatistics(String poolId, String triggerId);

  void doJobRunStatistics(Date beginTime, Date endTime, Integer maxSampleCount) throws Exception;
}
