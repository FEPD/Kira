...
public class NoJobBeCreatedAndRunForSomeTimeForTimerTriggerEvent
    extends KiraManagerHealthEvent {

  public NoJobBeCreatedAndRunForSomeTimeForTimerTriggerEvent(
