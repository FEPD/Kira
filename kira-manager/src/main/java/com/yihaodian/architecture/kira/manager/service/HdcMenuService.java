...
public interface HdcMenuService {

  void insert(HdcMenu hdcMenu);

  int update(HdcMenu hdcMenu);

  int delete(int id);

  HdcMenu select(int id);

  List<HdcMenu> list(HdcMenuCriteria hdcMenuCriteria);

  List<HdcMenu> listOnPage(HdcMenuCriteria hdcMenuCriteria);
