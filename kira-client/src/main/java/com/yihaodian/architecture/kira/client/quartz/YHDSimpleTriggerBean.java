...
public class YHDSimpleTriggerBean extends SimpleTriggerImpl implements IYHDSimpleTriggerBean,
  ...
  private Long startDelaySet;
  private Integer repeatCountSet;
  private Long repeatIntervalSet;
  ...
  //The start time and end time will be called for many times. So use below to make sure the startTimeSet and endTimeSet are the value set by spring injection.
  ...
  /**
   * 设置将被调用的服务方法所在的poolId,如果为空则表示调用自己pool暴露的服务方法。
   */
  ...
  @Override
  public Long getStartDelaySet() {
    return startDelaySet;
  }
  ...
  public void setRepeatCount(int repeatCount) {
    ...
    this.repeatCountSet = Integer.valueOf(repeatCount);
  }

  @Override
  public Integer getRepeatCountSet() {
    return repeatCountSet;
  }

  @Override
  public void setRepeatInterval(long repeatInterval) {
    super.setRepeatInterval(repeatInterval);
    this.repeatIntervalSet = Long.valueOf(repeatInterval);
  }

  @Override
  public Long getRepeatIntervalSet() {
    return repeatIntervalSet;
  }
