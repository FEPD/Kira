...
public class SystemUtil {
  ...
  public static boolean isLocalHost(String host) {
    return !HedwigUtil.isBlankString(host) && (LOCAL_IP_PATTERN.matcher(host).matches() || "localhost".equalsIgnoreCase(host));
  }
  ...
  public static boolean isIPv4Host(String host) {
    return !HedwigUtil.isBlankString(host) && IPV4_PATTERN.matcher(host).matches();
  }
