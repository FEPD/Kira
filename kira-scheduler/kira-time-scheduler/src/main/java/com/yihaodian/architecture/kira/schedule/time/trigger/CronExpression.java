...
/**
 * This file is from quartz and i make minor modification.
 *
 ...
 *
 * <table cellspacing="8"> <tr> <th align="left">Field Name</th> <th align="left">&nbsp;</th> <th
 * align="left">Allowed Values</th> <th align="left">&nbsp;</th> <th align="left">Allowed Special
 * Characters</th> </tr> <tr> <td align="left"><code>Seconds</code></td> <td
 ...
 * month 0 to 31, and for months 1 to 12. The &quot;/&quot; character simply helps you turn on every
 ...
 * important not to specify lists, or ranges of values, as you'll get confusing results. <P> The 'W'
 * character is allowed for the day-of-month field.  This character is used to specify the weekday
 * (Monday-Friday) nearest the given day.  As an example, if you were to specify &quot;15W&quot; as
 * the value for the day-of-month field, the meaning is: &quot;the nearest weekday to the 15th of
 * the month&quot;. So if the 15th is a Saturday, the trigger will fire on Friday the 14th. If the
 * 15th is a Sunday, the trigger will fire on Monday the 16th. If the 15th is a Tuesday, then it
 ...
 * day-of-month is a single day, not a range or list of days. <P> The 'L' and 'W' characters can
 * also be combined for the day-of-month expression to yield 'LW', which translates to &quot;last
 * weekday of the month&quot;. <P> The '#' character is allowed for the day-of-week field. This
 * character is used to specify &quot;the nth&quot; XXX day of the month. For example, the value of
 * &quot;6#3&quot; in the day-of-week field means the third Friday of the month (day 6 = Friday and
 * &quot;#3&quot; = the 3rd one in the month). Other examples: &quot;2#1&quot; = the first Monday of
 * the month and &quot;4#5&quot; = the fifth Wednesday of the month. Note that if you specify
 ...
 * day-of-week field (&quot;3#1,6#3&quot; is not valid, since there are two expressions). <P>
 ...
 * on or after Sunday".--> <P> The legal characters and the names of months and days of the week are
 * not case sensitive.
 *
 * <p> <b>NOTES:</b> <ul> <li>Support for specifying both a day-of-week and a day-of-month value is
 * not complete (you'll need to use the '?' character in one of these fields). </li> <li>Overflowing
...
public class CronExpression implements Serializable, Cloneable {
  ...
  public CronExpression(String cronExpression) throws ValidationException {
   ...
   */
  public CronExpression(String cronExpression, TimeZone timeZone) throws ValidationException {
    if (cronExpression == null) {
      throw new ValidationException("cronExpression cannot be null");
    }
  ...
  protected void buildExpression(String expression) throws ValidationException {
    ...
    try {
      ...
      throw new ValidationException(
          "ParseException occurs when buildExpression. expression=" + expression, pe);
    } catch (Exception e) {
      throw new ValidationException(
          "Exception occurs when buildExpression. expression=" + expression, e);
    }
  }
  ...
  protected void addToSet(int val, int end, int incr, int type)
    ...
    if (type == SECOND || type == MINUTE) {
      ...
      if (stopAt == -1) {
        stopAt = KiraCronTimerTrigger.YEAR_TO_GIVEUP_SCHEDULING_AT;
      }
      if (startAt == -1 || startAt == ALL_SPEC_INT) {
        startAt = 1970;
      }
  ...
  protected Date getTimeAfter(Date afterTime) {
    ...
    while (!gotOne) {
      ...
      // but keep looping...
      if (year > KiraCronTimerTrigger.YEAR_TO_GIVEUP_SCHEDULING_AT) {
        return null;
      }
  ...
  public Object clone() {
    ...
    } catch (ValidationException ex) { // never happens since the source is valid...
