...
public class KiraServerRuntimeDataCheckEvent extends KiraServerEvent {

  private KiraServerRuntimeData kiraServerRuntimeData;

  public KiraServerRuntimeDataCheckEvent(KiraServerEventType eventType,
  ...
  public String toString() {
    return "KiraServerRuntimeDataCheckEvent [kiraServerRuntimeData="
