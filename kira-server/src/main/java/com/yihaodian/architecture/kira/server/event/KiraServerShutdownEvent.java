...
public class KiraServerShutdownEvent extends KiraServerEvent {

  private KiraServerEntity kiraServerEntity;

  public KiraServerShutdownEvent(KiraServerEventType eventType,
  ...
  public String toString() {
    return "KiraServerShutdownEvent [kiraServerEntity=" + kiraServerEntity
        + ", eventType=" + eventType + ", eventTime=" + KiraCommonUtils.getDateAsString(eventTime)
        + "]";
  }
